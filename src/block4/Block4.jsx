            ...
            <div className="row">
                    <div className="col-lg-12">
                        <div className="main-title">
                            ...
                            <p>OUR TESITMONIAL <span></span></p>
                            <h2>Honourable Client Says About Me</h2>
                            </div>
                        </div>
                    </div>
            </div>
                <Slider dots>
                    ...
                    <div className="row">
                    <div className="col-lg-6">
                    <img src="https://preview.colorlib.com/theme/breed2/img/testimonials/xtestimonial1.png.pagespeed.ic.BCEh9h-yqD.webp" alt="" />
                </div>
                <div className="col-lg-6">
